...
var Cell = function (_React$Component) {
    ...
    _createClass(Cell, [{
        ...
        value: function render() {
            ...
            var arr = this.state.matches.map(function (elt, i) {
                return _react2.default.createElement(
                    'span',
                    { className: 'item holder', key: i },
                    _react2.default.createElement(_SingleResult2.default, { index: i, key: elt, store: _this2.props.store })
                );
            });

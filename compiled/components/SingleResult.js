...
var SingleResult = function (_React$Component) {
    ...
    function SingleResult() {
        ...
        var _this = _possibleConstructorReturn(this, (SingleResult.__proto__ || Object.getPrototypeOf(SingleResult)).call(this));
    ...
    _createClass(SingleResult, [{
        ...
        value: function render() {
            ...
            var heading = this.state.studies[index].name;
            return _react2.default.createElement(
                'div',
                { className: 'item', onClick: onResultClick },
                heading
            );
        }
    }]);
